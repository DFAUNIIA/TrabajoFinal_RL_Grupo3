...
class Environment(BaseEnvironment):
    ...
    def env_init(self, env_info={}):
        ...
        self.start_stock = 20 
        # env_info.get('initial_stock', 20) # State initial 20 items and life time of 3
        self.max_stock = env_info.get('capacity', 20)
        self.min_stock = 0

        self.max_loss = 100
        # env_info.get('max_loss', 100)
        self.cum_profit = 0
        self.lags_to_return = 1
        # env_info.get('lags_to_return',1) # Lags of states to return
        ...
        self.expiration_time = 30 # env_info.get('expiration_time', 30) # Expiration in days or 30
